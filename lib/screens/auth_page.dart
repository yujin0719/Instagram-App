...
import 'package:instagram_yujin/widgets/sign_in_form.dart';
import 'package:instagram_yujin/widgets/sign_up_form.dart';
      ...
      child: FlatButton(
        ...
        child: RichText(
          ...
          text: TextSpan(style: const TextStyle(), children: <TextSpan>[
            TextSpan(
                text: (currentWidget is SignUpForm)? "Don't have an account?" : "Already have an account?",
                style: TextStyle(
                    fontWeight: FontWeight.w300, color: Colors.black54)),
            TextSpan(
                text: (currentWidget is SignInForm)? "  Sign Up" : "  Sign In",
                style: TextStyle(
                    fontWeight: FontWeight.w300, color: Colors.blue[600])),
          ]),
        ),
      ),
    );
